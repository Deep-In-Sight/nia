...
public class SelectStatusActivity extends AppCompatActivity {
    ...
    private int selectStatusNum = -99;
    ...
    private void initView(){
        rdgTestLocation = findViewById(R.id.rdg_posture);
    ...
    private void setOnClickListener(){
        ...
        linear_next.setOnClickListener(view -> {
            if(selectStatusNum == -99){
                Toast.makeText(getApplicationContext(), "촬영자 상태를 선택해주세요", Toast.LENGTH_SHORT).show();
            }else{
                TestInfo testInfo = TestInfo.getInstance();
                testInfo.setStatus(selectStatusNum);
